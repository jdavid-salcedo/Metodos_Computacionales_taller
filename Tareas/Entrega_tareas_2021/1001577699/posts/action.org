...
:results:
# Out[490]:
[[file:./obipy-resources/pOaG01.svg]]
:end:
#+begin_src ipython :session asession :results raw drawer :exports both
...
:results:
# Out[491]:
[[file:./obipy-resources/crRAXq.svg]]
:end:
...
:results:
# Out[494]:
[[file:./obipy-resources/yPSUVs.svg]]
:end:
...
:results:
# Out[495]:
[[file:./obipy-resources/GEkU9L.svg]]
:end:
#+begin_src ipython :session asession :results raw drawer :exports both
...
:results:
# Out[496]:
[[file:./obipy-resources/g99Pi1.svg]]
:end:
...
:results:
# Out[498]:
[[file:./obipy-resources/82DvTx.svg]]
:end:
...
:results:
# Out[499]:
[[file:./obipy-resources/vBBCSp.svg]]
:end:
Similarly:
#+begin_src ipython :session asession :results raw drawer :exports both
# The spring problem
...
:results:
# Out[500]:
[[file:./obipy-resources/zj3Gg0.svg]]
:end:
